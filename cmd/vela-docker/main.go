...
func main() {
	...
	app.Flags = []cli.Flag{
		...
		&cli.StringFlag{
			...
			FilePath: string("/vela/parameters/log_level,/vela/secrets/docker/log_level"),
			Name:     "log.level",
		...
		&cli.StringFlag{
			...
			FilePath: string("/vela/parameters/build/event,/vela/secrets/docker/build/event"),
			Name:     "build.event",
			Usage:    "event triggered for build",
		},
		&cli.StringFlag{
			EnvVars:  []string{"PARAMETER_SHA", "BUILD_COMMIT"},
			FilePath: string("/vela/parameters/build/sha,/vela/secrets/docker/build/sha"),
			Name:     "build.sha",
			Usage:    "commit SHA-1 hash for build",
		},
		&cli.StringFlag{
			EnvVars:  []string{"PARAMETER_TAG", "BUILD_TAG"},
			FilePath: string("/vela/parameters/build/tag,/vela/secrets/docker/build/tag"),
			Name:     "build.tag",
		...
		&cli.StringSliceFlag{
			...
			FilePath: string("/vela/parameters/image/build_args,/vela/secrets/docker/image/build_args"),
			Name:     "image.build_args",
			Usage:    "variables passed to the image at build-time",
		},
		&cli.StringFlag{
			EnvVars:  []string{"PARAMETER_CONTEXT", "IMAGE_CONTEXT"},
			FilePath: string("/vela/parameters/image/context,/vela/secrets/docker/image/context"),
			Name:     "image.context",
		...
		&cli.StringFlag{
			...
			FilePath: string("/vela/parameters/image/dockerfile,/vela/secrets/docker/image/dockerfile"),
		...
		&cli.StringFlag{
			...
			FilePath: string("/vela/parameters/image/target,/vela/secrets/docker/image/target"),
			Name:     "image.target",
		...
		&cli.BoolFlag{
			...
			FilePath: string("/vela/parameters/dry_run,/vela/secrets/docker/dry_run"),
		...
		&cli.StringFlag{
			...
			FilePath: string("/vela/parameters/registry/name,/vela/secrets/docker/registry/name"),
			Name:     "registry.name",
		...
		&cli.StringFlag{
			...
			FilePath: string("/vela/parameters/registry/username,/vela/secrets/docker/registry/username,/vela/secrets/docker/username"),
		...
		&cli.StringFlag{
			...
			FilePath: string("/vela/parameters/registry/password,/vela/secrets/docker/registry/password,/vela/secrets/docker/password"),
		...
		&cli.BoolFlag{
			...
			FilePath: string("/vela/parameters/repo/auto_tag,/vela/secrets/docker/repo/auto_tag"),
			Name:     "repo.auto_tag",
			Usage:    "enables automatically providing tags for the image",
		},
		&cli.BoolFlag{
			EnvVars:  []string{"PARAMETER_CACHE", "REPO_CACHE"},
			FilePath: string("/vela/parameters/repo/cache,/vela/secrets/docker/repo/cache"),
			Name:     "repo.cache",
			Usage:    "enables caching of each layer for the image",
		},
		&cli.StringFlag{
			EnvVars:  []string{"PARAMETER_CACHE_REPO", "REPO_CACHE_NAME"},
			FilePath: string("/vela/parameters/repo/cache_name,/vela/secrets/docker/repo/cache_name"),
		...
		&cli.StringFlag{
			...
			FilePath: string("/vela/parameters/repo/name,/vela/secrets/docker/repo/name"),
			Name:     "repo.name",
			Usage:    "repository name for the image",
		},
		&cli.StringSliceFlag{
			EnvVars:  []string{"PARAMETER_TAGS", "REPO_TAGS"},
			FilePath: string(".tags,/vela/parameters/repo/tags,/vela/secrets/docker/repo/tags"),
			Name:     "repo.tags",
		...
		&cli.StringSliceFlag{
			...
			FilePath: string("/vela/parameters/repo/labels,/vela/secrets/docker/repo/labels"),
			Name:     "repo.labels",
